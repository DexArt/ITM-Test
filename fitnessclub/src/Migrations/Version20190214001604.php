 ...
 */
final class Version20190214001604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , auth_token VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_authorised BOOLEAN DEFAULT \'0\' NOT NULL)');
