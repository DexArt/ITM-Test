 ...
 */
final class Version20190214081156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, firstname, lastname, email, password, gender, birthday, roles, auth_token, is_authorised, phone FROM user');
        ...
        , auth_token VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_authorised BOOLEAN DEFAULT NULL, phone VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, firstname, lastname, email, password, gender, birthday, roles, auth_token, is_authorised, phone) SELECT id, firstname, lastname, email, password, gender, birthday, roles, auth_token, is_authorised, phone FROM __temp__user');
